package com.lin.linloannotificationmodule.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, Object> linLoanConsumerFactory() {
        ...
        linLoanConfigurationProperties.put(JsonDeserializer.VALUE_DEFAULT_TYPE, KafkaConsumerService.class.getName());
